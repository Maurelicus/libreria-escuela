...
def seccion_dos(frame_dos, frame_tabla, lista_metodos, lista_atributos, photo1, photo2, tabla):
    frame_busqueda = ttk.LabelFrame(frame_dos, text='Opciones')
    frame_busqueda.grid(column=0, row=0, padx=5, pady=5, sticky='ew')
    ...
    #! SCROLLBARS
    ladox = ttk.Scrollbar(frame_tabla, orient='horizontal', command=tabla.xview)
    ladox.grid(column=1, row=1, sticky='ew', padx=5)
    ladoy = ttk.Scrollbar(frame_tabla, orient='vertical', command=tabla.yview)
    ladoy.grid(column=0, row=0, sticky='ns', pady=5)
    tabla.configure(xscrollcommand=ladox.set, yscrollcommand=ladoy.set)
    #! COLUMNAS
    tabla['columns'] = ('Remitente', 'Añorecepcion', 'Niveleducativo', 'Titulo', 'Autor', 'Editorial', 'Añoedicion', 'Condicion', 'Cantidad')
    tabla.column('#0', minwidth=60, width=60, anchor='center')
    tabla.column('#1', minwidth=100, width=100, anchor='center')
    tabla.column('#2', minwidth=100, width=120, anchor='center')
    tabla.column('#3', minwidth=120, width=120, anchor='center')
    tabla.column('#4', minwidth=200, width=200, anchor='w')
    tabla.column('#5', minwidth=200, width=200, anchor='w')
    tabla.column('#6', minwidth=100, width=105, anchor='w')
    tabla.column('#7', minwidth=100, width=100, anchor='center')
    tabla.column('#8', minwidth=90, width=90, anchor='center')
    tabla.column('#9', minwidth=90, width=90, anchor='center')
        
    tabla.heading('#0', text='Nº', anchor='center')
    tabla.heading('#1', text='Remitente', anchor='center')
    tabla.heading('#2', text='Año recepcion', anchor='center')
    tabla.heading('#3', text='Nivel educativo', anchor='center')
    tabla.heading('#4', text='Titulo', anchor='center')
    tabla.heading('#5', text='Autor', anchor='center')
    tabla.heading('#6', text='Editorial', anchor='center')
    tabla.heading('#7', text='Año edicion', anchor='center')
    tabla.heading('#8', text='Condicion', anchor='center')
    tabla.heading('#9', text='Cantidad', anchor='center')
    
    tabla.bind("<<TreeviewSelect>>", lista_metodos[2])
    tabla.bind("<Double-1>", lista_metodos[3])
