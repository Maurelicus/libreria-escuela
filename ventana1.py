...
class Widgets1v():
    ...
    def seccion_uno(self, frame_uno):
        ...
        año_recepcion.grid(column=0, row=1, padx=30, pady=5, sticky='w')
        nivel_educativo = ttk.Label(frame_uno, text='Nivel Educativo')
        nivel_educativo.grid(column=0, row=2, padx=30, pady=5, sticky='w')
        titulo = ttk.Label(frame_uno, text='Titulo')
        titulo.grid(column=0, row=3, padx=30, pady=5, sticky='w')
        autor = ttk.Label(frame_uno, text='Autor')
        autor.grid(column=0, row=4, padx=30, pady=5, sticky='w')
        editorial = ttk.Label(frame_uno, text='Editorial')
        editorial.grid(column=0, row=5, padx=30, pady=5, sticky='w')
        año_edicion = ttk.Label(frame_uno, text='Año de edicion')
        año_edicion.grid(column=0, row=6, padx=30, pady=5, sticky='w')
        condicion_libro = ttk.Label(frame_uno, text='Condicion')
        condicion_libro.grid(column=0, row=7, padx=30, pady=5, sticky='w')
