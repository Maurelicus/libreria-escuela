...
class VentanaLaminas():
    ...
    def seccion_uno(self, frame_datos):
        ...
        #! Botones
        update_boton = ttk.Button(frame_datos, text='Actualizar Lamina', width=15, command=self.actualizar_lamina, bootstyle='primary-outline')
    ...
    def agregar_lamina(self):
        ...
        if palabra in codigos:
            ...
            if codigo and remitente and niveleducativo and titulo and condicionlamina != '' and cantidad > 0:
                ...
                if question_box == 'yes':
                    self.bd.append_lamina(codigo, remitente, añorecepcion, niveleducativo, titulo, condicionlamina, cantidad)
